        ...
        <>
          <div className="flex items-center gap-3 rounded-lg bg-[var(--success-50)] px-4 py-5 shadow-[var(--shadow-card)]">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-[13.5px] text-[var(--success-600)] opacity-80">
  ...
  return (
    ...
    >
      <span className="flex w-16 shrink-0 flex-col items-start">
        ...
        <span className="text-ink-3 mt-1 font-mono text-[11.5px] whitespace-nowrap">
      ...
      <span className="min-w-0 flex-1">
        ...
        <span className="text-ink-2 mt-1 block truncate text-[13.5px]">
