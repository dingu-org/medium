...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-white px-7 py-8">
      ...
      <footer className="text-ink-3 relative mt-8 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs">
