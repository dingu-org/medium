...
export const metadata = {
  ...
  description:
    'Çfarë përfshijnë planet Falas dhe Solo, si maten bisedat dhe kujtesat, dhe si kalon te Solo.',
};
    ...
    <article lang="sq" className="space-y-10">
      ...
      <PolicySection title="Çfarë përfshin Falas">
        ...
        <ul>
          ...
          <li>{free.remindersPerMonth} kujtesa në muaj;</li>
      ...
      <PolicySection title="Çfarë përfshin Solo">
        ...
        <ul>
          ...
          <li>{solo.remindersPerMonth} kujtesa në muaj;</li>
      ...
      <PolicySection title="Kur arrin kufirin">
        <p>
          Kur mbaron kufiri mujor, asistenti ndalon vetëm përgjigjet
          automatike. Pacientit i dërgohet një mesazh i vetëm që dikush nga
          praktika do t’i përgjigjet, dhe biseda shënohet që ta shohësh.
        </p>
        <p>
      ...
      <PolicySection title="Si të kalosh te Solo">
        <p>
          Kalimi te Solo bëhet te <strong>Cilësimet → Plani &amp; pagesat</strong>:
          zgjidh planin Solo dhe periudhën që të përshtatet — mujore ose vjetore.
        </p>
        <p>
          Hapi i pagesës po shtohet ende. Për momentin do të shohësh njoftimin{' '}
          <strong>“Pagesat vijnë së shpejti”</strong>; sapo të aktivizohet, do të
          mund ta përfundosh pagesën direkt aty dhe Solo aktivizohet menjëherë.
        </p>
      </PolicySection>
      ...
      <PolicySection title="Periudhat e parapaguara">
        <p>
          ...
          të vazhdosh. Plani mbetet aktiv deri në fund të periudhës që ke paguar.
        </p>
      </PolicySection>
      ...
      <PolicySection title="Nëse plani skadon">
        <p>
          ...
          përfitimet e Solo-s vazhdojnë të vlejnë. Pas kësaj kthehesh vetvetiu te
          plani Falas. Asgjë nuk fshihet gjatë këtij afati.
        </p>
      </PolicySection>
      ...
      <PolicySection title="Kur kthehesh te Falas">
        ...
        <p>
          ...
          pas një afati prej 30 ditësh nga kthimi, që të kesh kohë të rikalosh te
          Solo pa humbur asgjë.
        </p>
      </PolicySection>
