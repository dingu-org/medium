...
export const calendar = {
  ...
  existingCustomer: 'Pacient ekzistues',
  newCustomer: 'Pacient i ri',
  ...
  pickCustomer: 'Zgjidh një pacient.',
  enterCustomerDetails: 'Vendos emrin dhe telefonin e pacientit.',
...
export const reminder = {
  ...
  confirmed: 'Konfirmuar',
  cancelledByCustomer: 'Anuluar nga pacienti',
