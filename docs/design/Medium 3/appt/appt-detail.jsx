...
const DetailNotes = () => (
  <SheetShell title="Anila Hoxha" titleRight={<CalPill status="confirmed" />}>
    <DetailBody date="E mërkurë, 6 maj" time="10:00–10:45" service="Konsultë e parë" reminder="confirmed">
      <div style={{ minHeight: 64, padding: "11px 14px", border: `1px solid ${MT.brand}`, borderRadius: 10, background: "#fff", fontSize: 14, lineHeight: 1.5, color: MT.ink, boxShadow: "0 0 0 3px rgba(31,93,134,0.16)" }}>Sjell rezultatet e fundit të MRI-së.<span style={{ display: "inline-block", width: 2, height: 18, background: MT.brand, marginLeft: 2, verticalAlign: "text-bottom" }} /></div>
