  ...
  <Spec name="Avatars" purpose="Initials on brand-tint. Status dot signals who's handling: sage/blue Medium, green you.">
    ...
    <Block label="App mark">
      <Cell cap="M-mark · sage dot">
        <svg width="48" height="48" viewBox="0 0 40 40" fill="none"><rect width="40" height="40" rx="10" fill="#1F5D86" /><path d="M11 27V13h2.4l4.1 7.6 4.1-7.6h2.4v14h-2.2v-9.5l-3.6 6.6h-1.4l-3.6-6.6V27H11Z" fill="#fff" /><circle cx="29.5" cy="13.5" r="1.6" fill="#7CC4A8" /></svg>
      </Cell>
    </Block>
  </Spec>
);
