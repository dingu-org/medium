...
const FoundationColor = () => (
  <Spec name="Color" purpose="Cool-neutral spine carries 95% of surface. One brand blue for action; semantics only in their role.">
    <Block label="Brand · clinical blue">
      <Sw c={MT.brand} name="brand-500" val="#1F5D86" fg="#fff" />
      <Sw c={MT.brandInk} name="brand-ink" val="#114063" fg="#fff" />
      <Sw c={MT.brandTint} name="brand-tint" val="#ecf3f9" fg={MT.brandInk} />
      <Sw c={MT.sage} name="sage · dot" val="#7CC4A8" fg="#1b4736" />
    </Block>
    <Block label="Semantic">
      <Sw c={MT.green} name="success" val="#2f8b5a" fg="#fff" />
      <Sw c={MT.amber} name="warning" val="#b97a08" fg="#fff" />
      <Sw c={MT.red} name="danger" val="#b3322b" fg="#fff" />
      <Sw c={MT.brand} name="info" val="#1F5D86" fg="#fff" />
    </Block>
...
const FoundationShape = () => (
  <Spec name="Shape & elevation" purpose="Hairlines do the work. Restrained radius, three low-spread elevation levels.">
    ...
    <Block label="Focus ring">
      <Cell cap="3px brand @18%"><div style={{ width: 96, height: 48, borderRadius: 12, background: "#fff", border: `1px solid ${MT.brand}`, boxShadow: "0 0 0 3px rgba(31,93,134,0.18)" }} /></Cell>
    </Block>
  </Spec>
);
