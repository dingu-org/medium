...
const NoteBlock = ({ children, editing }) => (
  <div style={{ marginTop: 20 }}>
    ...
    {editing
      ? <div style={{ minHeight: 60, padding: "11px 14px", border: `1px solid ${MT.brand}`, borderRadius: 10, background: "#fff", fontSize: 14, lineHeight: 1.5, color: MT.ink, boxShadow: "0 0 0 3px rgba(31,93,134,0.16)" }}>{children}<span style={{ display: "inline-block", width: 2, height: 18, background: MT.brand, marginLeft: 2, verticalAlign: "text-bottom" }} /></div>
      : children
