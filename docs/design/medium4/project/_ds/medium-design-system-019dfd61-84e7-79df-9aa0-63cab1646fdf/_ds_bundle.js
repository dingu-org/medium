...
const RadioCard = ({
  ...
  style: {
    ...
    textAlign: "left",
    cursor: "pointer",
    background: selected ? "#EAEEFF" : "#fff",
    border: `1px solid ${selected ? "#3B5BFE" : "#e3e7ed"}`,
    borderRadius: 10,
    fontFamily: "Manrope, sans-serif",
  ...
  style: {
    ...
    height: 32,
    borderRadius: 8,
    background: selected ? "#3B5BFE" : "#eef0f4",
    display: "inline-flex",
    alignItems: "center",
  ...
  style: {
    ...
    height: 18,
    borderRadius: 999,
    border: `1.5px solid ${selected ? "#3B5BFE" : "#d4dae3"}`,
    display: "inline-flex",
    alignItems: "center",
    justifyContent: "center",
    flexShrink: 0,
...
const OnboardingShell = ({
  ...
  style: {
    ...obStyles.dot,
    background: i <= step ? "#3B5BFE" : "#e3e7ed",
    width: i === step ? 18 : 6
  }
}))), /*#__PURE__*/React.createElement("button", {
  style: obStyles.skip
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(StepHeader, {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        padding: "10px 16px",
        borderRadius: 6,
        background: sel ? "#3B5BFE" : "#fff",
        color: sel ? "#fff" : "#4b5563",
        border: `1px solid ${sel ? "#3B5BFE" : "#d4dae3"}`,
        fontFamily: "Manrope, sans-serif",
        fontSize: 13,
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(StepHeader, {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        gap: 12,
        padding: "14px 16px",
        background: sel ? "#EAEEFF" : "#fff",
        border: `1px solid ${sel ? "#3B5BFE" : "#e3e7ed"}`,
        borderRadius: 10,
        cursor: "pointer",
        textAlign: "left",
        boxShadow: sel ? "0 0 0 3px rgba(59, 91, 254, 0.12)" : "none"
      }
    }, /*#__PURE__*/React.createElement("div", {
      style: {
        width: 18,
        height: 18,
        borderRadius: 4,
        border: `1.5px solid ${sel ? "#3B5BFE" : "#d4dae3"}`,
        background: sel ? "#3B5BFE" : "#fff",
        display: "inline-flex",
        alignItems: "center",
        justifyContent: "center"
  ...
  return /*#__PURE__*/React.createElement("aside", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        fontSize: 13,
        lineHeight: 1.45,
        background: isMe ? "#3B5BFE" : isAi ? "#EAEEFF" : "#fff",
        color: isMe ? "#fff" : isAi ? "#1E2F9A" : "#0F1420",
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        ...
        textAlign: "left",
        cursor: "pointer",
        outline: isSel ? "2px solid #3B5BFE" : "none",
...
const ScreenCalendar = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      alignItems: "center",
      justifyContent: "center",
      background: dd.on ? "#3B5BFE" : "transparent",
...
const ScreenAvail = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      padding: "8px 0",
      borderRadius: 6,
      background: m === 45 ? "#3B5BFE" : "transparent",
...
const s_tag = ai => ({
  ...
  borderRadius: 999,
  fontWeight: 500,
  background: ai ? "#EAEEFF" : "#eef0f4",
  color: ai ? "#1E2F9A" : "#4b5563",
  flexShrink: 0
});
const s_unread = {
  background: "#3B5BFE",
