...
const LogoMark = ({ size = 46 }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" fill="none"><rect width="40" height="40" rx="11" fill="#3B5BFE" /><path d="M11 27V13h2.4l4.1 7.6 4.1-7.6h2.4v14h-2.2v-9.5l-3.6 6.6h-1.4l-3.6-6.6V27H11Z" fill="#fff" /><circle cx="29.5" cy="13.5" r="1.8" fill="#7CC4A8" /></svg>
);
...
const AField = ({ label, value, placeholder, type = "text", state = "default", hint, error }) => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
      ...
      <div style={{ height: 50, padding: "0 16px", border: `1px solid ${bc}`, borderRadius: 12, background: "#fff", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8, boxShadow: focused ? "0 0 0 3px rgba(59,91,254,0.16)" : isErr ? "0 0 0 3px rgba(179,50,43,0.12)" : "none", fontSize: 15.5 }}>
        {value
