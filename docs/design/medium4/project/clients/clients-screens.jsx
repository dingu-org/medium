    ...
    <Body pad="18px 20px 24px">
      <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
        <div style={{ width: "100%" }}><div style={{ fontSize: 13, fontWeight: 600, color: "#303744", marginBottom: 7 }}>Emri</div>
          <div style={{ height: 50, padding: "0 16px", border: `1px solid ${MT.brand}`, borderRadius: 12, background: "#fff", display: "flex", alignItems: "center", boxShadow: "0 0 0 3px rgba(59,91,254,0.16)", fontSize: 15.5, color: MT.ink }}>Blerta Doci<span style={{ width: 2, height: 20, background: MT.brand, borderRadius: 2, marginLeft: 2 }} /></div>
        </div>
