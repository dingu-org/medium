...
const ThreadAI = () => (
  <CThread patient="Anila Hoxha"
    ...
    messages={<React.Fragment>
      <CSys>4 maj · klientja nisi bisedën</CSys>
      ...
      <CBubble side="left" who="ai" text="Mirë, ju kam rezervuar të mërkurën më 6 maj në orën 10:00. A doni një kujtesë një ditë para?" meta="09:05" />
    </React.Fragment>}
...
const ThreadEscalated = () => (
  <CThread patient="Dritan Sopa"
    ...
    notice={<CNotice tone="danger" icon="bell" text="Pacienti kërkoi të flasë me një person. Medium ndaloi përgjigjet." />}
    messages={<React.Fragment>
