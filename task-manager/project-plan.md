...
| 3 | [AI conversation engine](phases/03-ai-conversation-engine.md) | OpenRouter-routed Llama turns with tools under a pinned model guardrail | 4–5 days | 1 (can overlap with 2) |
...
| 11 | [Observability](phases/11-observability.md) | Structured logs, internal funnel metrics, and cost dashboards | 2–3 days | 0 (can overlap throughout) |
...
- **Phase 11 (Observability)** is best added incrementally as features ship — platform logs from Phase 0, structured logs from Phase 5, and internal funnel metrics from Phase 7. The dedicated phase is for polish + dashboards.
...
- Basic observability: structured logs + cost dashboards + a couple of internal metrics.
...
| AI cost overruns | Current guardrail keeps runtime AI cost near zero; still capture usage in case a paid fallback is introduced later. | 3, 11 |
