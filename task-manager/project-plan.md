...
| 3 | [AI conversation engine](phases/03-ai-conversation-engine.md) | Claude turns with tools, prompt caching, Haiku→Sonnet escalation | 4–5 days | 1 (can overlap with 2) |
...
| AI cost overruns | Budget alerts on Anthropic at 50 % and 90 %; default model is Haiku; cache static prompt sections. | 3, 11 |
