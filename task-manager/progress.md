...
- Remaining: external accounts, Sentry wizard, Vercel envs, GitHub remote, first push/deploy, and mobile preview checks.
...
- Supabase, Vercel, Inngest, Anthropic, Sentry, and PostHog account creation.
- GitHub remote creation and first push to `main`.
...
- Not complete yet: GitHub remote and first push, Vercel project and env wiring, Supabase/Inngest/Anthropic/Sentry/PostHog accounts, Meta Business/App Review, Sentry wizard plus test error verification, Vercel preview deploy, and mobile device preview checks.
