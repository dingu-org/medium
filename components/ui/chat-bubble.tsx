  ...
  return (
    <div className={cn('flex', mine ? 'justify-end' : 'justify-start')}>
      <div className="max-w-[84%]">
        {ai && !grouped && (
          <div className="text-primary mb-1 inline-flex items-center gap-1.5 font-mono text-[10px] font-medium">
            <span
        ...
        <div
          className={cn(
            ...
            mine &&
              'bg-primary text-primary-foreground rounded-br-[5px] shadow-[var(--shadow-card)]',
            ai &&
              'rounded-bl-[5px] bg-[var(--brand-50)] text-[var(--brand-700)]',
            role === 'patient' &&
        ...
        {!grouped && (
          <div
            className={cn(
              'text-muted-foreground mt-1 flex items-center gap-1.5 px-1 font-mono text-[10.5px]',
